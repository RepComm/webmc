...
import { Texture, TextureLoader, Vec2 } from "ogl-typescript";
import { VariantBlockFacing, BlockType } from "../voxel/blockdef.js";
import { Globals } from "./global.js";

//const LinearMipmapLinearFilter = Globals.gl.LINEAR_MIPMAP_LINEAR;
// const NearestFilter = Globals.gl.NEAREST;

/**UV Quad from the texture atlas
 * All coordinates are in normalized 0..1 space
 */
export interface UVQuad {
  x: number;
  y: number;
  w: number;
  h: number;
